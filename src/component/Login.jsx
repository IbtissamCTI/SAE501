	...
	return (
		...
		>
			<form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
				...
				<button className="w-full bg-indigo-600 hover:bg-indigo-500 text-white font-semibold py-3.5 rounded-xl transition-all shadow-[0_0_20px_-5px_rgba(79,70,229,0.5)] hover:shadow-[0_0_25px_-5px_rgba(79,70,229,0.7)] flex items-center justify-center gap-2 group">
					Se connecter
					<ArrowRight
						size={18}
